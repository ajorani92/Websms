...
use Websms\UserBundle\Entity\User;
use Websms\UserBundle\Form\UserType;
use Websms\UserBundle\Form\UserFilterType;
...
class UserController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('UserBundle:User')->createQueryBuilder('e');
